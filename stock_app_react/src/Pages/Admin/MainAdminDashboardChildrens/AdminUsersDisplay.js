    ...
    <div className='w-full h-full flex flex-col justify-center items-center'>
      ...
      <div className='w-[90%] h-[80%] max-h-[80%] flex flex-col gap-5 '>
        ...
        <div className='w-full h-auto overflow-scroll flex flex-col gap-4'>
          {totalData.ADMINLISTOFTRADERS.length !== 0 ? totalData.ADMINLISTOFTRADERS.map((trader) => {
            return <div onClick={(e) => goToUser(e)} className='w-full h-[60px] bg-container-light-blue rounded-[20px] hover:bg-blue-400 flex justify-start items-center gap-2 p-2 cursor-pointer'>
              {/* <img className='w-[70px] h-[70px]' src={UserIcon} /> */}
              <UserIcon size={"30"} />
